...
- Brand/product sources of truth: `PRODUCT.md`, `DESIGN.md` (Night Watch Desk; lantern mark; Geist + JetBrains Mono; signal-blue / lantern-amber). Display brand spelling in UI chrome: **WatchTower**. License: GPL-3.0-or-later. Public: Modrinth + GitHub `djinnbanter/WatchTower`.
