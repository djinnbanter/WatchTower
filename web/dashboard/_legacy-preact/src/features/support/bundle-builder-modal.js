...
export function SupportBundleBuilderModal() {
  ...
  const soft = catalog?.soft_budget_bytes ?? 25 * 1024 * 1024;
  const hard = catalog?.hard_budget_bytes ?? 100 * 1024 * 1024;
        ...
        <section class="feat-support-builder__section">
          ...
          <div class="feat-support-builder__summary">
            <div class="feat-support-builder__summary-main">
              ...
              <div class="ui-text-low">Soft ${formatBytes(soft)} · Hard ${formatBytes(hard)}</div>
            </div>
            <div class="feat-support-builder__badge">Secrets stripped</div>
          </div>
          ${estimate > soft ? html`<div class="feat-support-builder__warn">Over soft budget — large files may be trimmed.</div>` : null}
          ${estimate > hard ? html`<div class="feat-support-builder__warn">Over hard budget — Full logs fall back to tails.</div>` : null}
