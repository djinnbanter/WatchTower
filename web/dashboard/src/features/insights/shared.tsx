...
export const INSIGHTS_NAV = [
  ...
  { id: 'world', label: 'World', view: 'world' as const, panel: null },
  { id: 'storage', label: 'Storage', view: 'storage' as const, panel: null },
  { id: 'digest', label: 'Digest', view: 'digest' as const, panel: null },
] as const;
...
export function activeInsightsNavId(view: string, panel: string): InsightsNavId {
  ...
  if (view === 'configs' || view === 'mod-changes' || view === 'world' || view === 'storage' || view === 'digest') {
    return view;
  }
  return 'overview';
}
