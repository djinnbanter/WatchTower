...
import { EmptyState, ErrorState, HeroCard, StatusPill, VitalTile } from '@/ui/patterns';
              ...
              return (
                ...
                >
                  ...
                  <div className="su-phase__bar" aria-hidden>
                    <span style={{ transform: `scaleX(${Math.min(1, Math.max(0, pct / 100))})` }} />
                  </div>
                </div>
              );
            })}
    ...
    <PageEnter className="su-stack">
      <FadeIn>
        <HeroCard
          ...
          coneSpread={18}
        >
          <div className="su-hero__body wt-hero-shell">
            <HeroWatermark
              icon={RocketIcon}
              tone={
                tone === 'ok'
            ...
            <div className="su-hero__head">
              ...
              <div className="su-hero__total">
                <span className="su-hero__total-label">Total boot time</span>
                <span className="su-hero__total-value">{formatSec(profile.total_sec)}</span>
              </div>
            </div>
