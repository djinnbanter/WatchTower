...
function FeatureTile({ Icon, title, body }: Feature) {
  return (
    <div className="roadmap-tile">
      ...
      <div className="roadmap-tile__copy">
  ...
  return (
    <PageEnter className="roadmap space-y-10">
      <div className="roadmap-plate overflow-hidden">
        <div className="p-6 md:p-8">
          <div className="flex flex-wrap items-start gap-3">
            <div className="grid h-12 w-12 shrink-0 place-items-center rounded-[var(--radius-wt-lg)] bg-wt-accent/15 text-wt-accent">
              <Compass size={22} />
            </div>
          ...
          <div className="mt-5 flex flex-wrap items-center gap-2">
            ...
            <a
              className="inline-flex items-center gap-1.5 rounded-[var(--radius-wt)] px-2.5 py-1.5 text-sm text-wt-text-mid hover:bg-wt-accent-soft/50 hover:text-wt-accent"
      ...
      <Section title="Works today" icon={CheckCircle2} hint="Already in the jar you can download.">
        <Stagger className="roadmap-list">
      ...
      <Section title="Coming next" icon={Wrench} hint="Planned work, grouped by the problem it solves for you.">
            ...
            <div key={group.theme} className="roadmap-plate h-full">
              <div className="flex h-full flex-col gap-3 p-4 md:p-5">
                <div className="flex items-center gap-2.5">
                  <span className="grid h-8 w-8 place-items-center rounded-[var(--radius-wt-sm)] bg-wt-accent/12 text-wt-accent">
                    <group.Icon size={16} />
                  </span>
