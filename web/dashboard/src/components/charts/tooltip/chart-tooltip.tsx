...
import { formatChartHoverTitle } from "../chart-formatters";
...
const ChartTooltipInner = memo(function ChartTooltipInner({
  ...
  const title = useMemo(() => {
    ...
    // For line/area charts, show date + time (Live / intra-day scrubbing)
    return formatChartHoverTitle(xAccessor(tooltipData.point));
