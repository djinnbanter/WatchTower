...
/**
 * Hero subnav: flat strip with a sliding near-square accent via shared `layoutId`.
 * Pass a unique `layoutGroupId` per page so indicators don't animate across routes.
 */
