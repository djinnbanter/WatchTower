/**
 * Watchtower specular CTA — WebGL rim highlight that follows the pointer (`ogl`).
 * Inspired by common specular-button patterns; not Redistributed React Bits source.
 */
