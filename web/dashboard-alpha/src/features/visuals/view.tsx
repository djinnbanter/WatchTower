...
export function PageView({ route }: { route: RouteState }) {
  ...
  return (
    <PageEnter className={`space-y-10 ${exporting ? 'wt-shot-exporting' : ''}`}>
      <section className="rounded-2xl border border-wt-line bg-wt-bg1/80 p-5 md:p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-start gap-3">
            <div className="grid h-11 w-11 place-items-center rounded-2xl bg-wt-accent/15 text-wt-accent">
              <Camera size={20} />
            </div>
            <div>
      ...
      <section className="rounded-2xl border border-dashed border-wt-line bg-wt-bg2/40 p-5">
