            ...
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                <div className="flex items-center gap-2">
                  <Package size={18} className="text-wt-ok" />
      ...
      <FadeIn>
        <div className="relative rounded-[var(--radius-wt)] border border-wt-line bg-wt-bg1/90 p-5">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-2">
                <Package size={18} className="text-wt-accent" />
          ...
          <div className="in-mod-stat-grid mt-4">
            {(
              [
                { id: 'added' as const, label: 'Added', count: counts.added, icon: ArrowUpRight, tone: 'ok' },
                {
                  id: 'removed' as const,
                  label: 'Removed',
              ...
              return (
                ...
                >
                  ...
                  <div className="in-mod-stat__value">{s.count}</div>
