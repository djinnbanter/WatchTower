              ...
              <ul className="space-y-1">
                {roots.map((r) => (
                  <li key={r.path}>
                    <button
                      type="button"
                      className="flex w-full items-center justify-between gap-3 rounded-xl border border-wt-line bg-wt-bg2/40 px-3 py-2.5 text-left text-sm hover:border-wt-accent/40"
