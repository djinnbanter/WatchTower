...
import { OvButton } from '@/features/overview/OvButton';
...
import { FadeIn, SpotlightCard, useCountUp } from '@/ui/motion';
...
function Panel({
  ...
  return (
    <SpotlightCard className={`md-mr-panel${className ? ` ${className}` : ''}`}>
