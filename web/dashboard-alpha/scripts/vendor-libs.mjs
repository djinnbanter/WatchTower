#!/usr/bin/env node
/**
 * One-time vendoring: download Preact, signals, HTM, uPlot, and UI fonts
 * (IBM Plex, Inter, Plus Jakarta Sans, JetBrains Mono).
...
const FONT_FILES = [
  ...
  /* Sass skin (Classic) — Inter + JetBrains Mono; Plus Jakarta kept for legacy assets */
  {
    url: `https://cdn.jsdelivr.net/fontsource/fonts/inter@${FONTSOURCE_VERSION}/latin-400-normal.woff2`,
    dest: 'Inter-Regular.woff2',
  },
  {
    url: `https://cdn.jsdelivr.net/fontsource/fonts/inter@${FONTSOURCE_VERSION}/latin-500-normal.woff2`,
    dest: 'Inter-Medium.woff2',
  },
  {
    url: `https://cdn.jsdelivr.net/fontsource/fonts/inter@${FONTSOURCE_VERSION}/latin-600-normal.woff2`,
    dest: 'Inter-SemiBold.woff2',
  },
  {
    url: `https://cdn.jsdelivr.net/fontsource/fonts/inter@${FONTSOURCE_VERSION}/latin-700-normal.woff2`,
    dest: 'Inter-Bold.woff2',
  },
  {
    url: `https://cdn.jsdelivr.net/fontsource/fonts/plus-jakarta-sans@${FONTSOURCE_VERSION}/latin-400-normal.woff2`,
    dest: 'PlusJakartaSans-Regular.woff2',
  },
  {
    url: `https://cdn.jsdelivr.net/fontsource/fonts/plus-jakarta-sans@${FONTSOURCE_VERSION}/latin-500-normal.woff2`,
    dest: 'PlusJakartaSans-Medium.woff2',
  },
  {
    url: `https://cdn.jsdelivr.net/fontsource/fonts/plus-jakarta-sans@${FONTSOURCE_VERSION}/latin-600-normal.woff2`,
    dest: 'PlusJakartaSans-SemiBold.woff2',
  },
  {
    url: `https://cdn.jsdelivr.net/fontsource/fonts/plus-jakarta-sans@${FONTSOURCE_VERSION}/latin-700-normal.woff2`,
    dest: 'PlusJakartaSans-Bold.woff2',
  },
  {
    url: `https://cdn.jsdelivr.net/fontsource/fonts/jetbrains-mono@${FONTSOURCE_VERSION}/latin-400-normal.woff2`,
    dest: 'JetBrainsMono-Regular.woff2',
  },
  {
    url: `https://cdn.jsdelivr.net/fontsource/fonts/jetbrains-mono@${FONTSOURCE_VERSION}/latin-600-normal.woff2`,
    dest: 'JetBrainsMono-SemiBold.woff2',
  },
];
...
async function main() {
  ...
  console.log('Downloading fonts (IBM Plex + Sass skin)…');
